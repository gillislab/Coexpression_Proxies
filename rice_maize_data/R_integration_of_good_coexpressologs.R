...
correct_integration_loom = Connect(filename = "~/passala/Generated_Tables/Temp_junk/ultra_slim_concatenated_rice_maize_genes_aligned_by_coexpressolog_and_11.loom", mode = "r")
...
correct_integration_seurat.combined.loom <- as.loom(correct_integration_seurat.combined, filename = "~/passala/Generated_Tables/Temp_junk/integrated_by_default_seurat_all_coexpressalog_and11.loom", verbose = FALSE)
