...
correct_integration_loom = Connect(filename = "~/passala/Generated_Tables/Temp_junk/slimmed_concatenated_rice_maize_genes_aligned_by_only_one_to_ones.loom", mode = "r")
...
correct_integration_seurat.combined.loom <- as.loom(correct_integration_seurat.combined, filename = "~/passala/Generated_Tables/Temp_junk/integrated_by_default_seurat_only11.loom", verbose = FALSE)
